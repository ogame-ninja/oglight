...
class UIManager extends Manager {
  ...
  turnIntoPlayerLink(e, t, n, o) {
    t.setAttribute("title", "loading..."), t.classList.add("tooltipUpdate"), t.classList.add("tooltipRight"), t.classList.add("tooltipClose"), n && o && ("status_abbr_inactive" === o ? t.innerHTML = `${n} (<b>${this.ogl.db.serverData.inactive}</b>)` : "status_abbr_longinactive" === o && (t.innerHTML = `${n} (<b>${this.ogl.db.serverData.inactiveLong}</b>)`)), t.addEventListener("click", (t => {
...
class TopbarManager extends Manager {
  ...
  openSettings(e) {
    ...
    let n;
    ["defaultShip", "defaultMission", "profileButton", "resourceTreshold", "msu", "sim", "converter", "useClientTime", "keyboardActions", "showMenuResources", "shortcutsOnRight", "disablePlanetTooltips", "reduceLargeImages", "displayPlanetTimers", "expeditionValue", "expeditionRandomSystem", "expeditionRedirect", "expeditionBigShips", "expeditionShipRatio", "ignoreExpeShipsLoss", "ignoreConsumption", "displaySpyTable", "boardTab", "ptreTeamKey", "ptreLogs", "manageData", "debugMode"].forEach((e => {
...
class FleetManager extends Manager {
  ...
  fleetSent(e) {
    ...
    if (n.conso = (n.conso || 0) + Math.min(this.initialResOnPlanet.deut, t), this.isQuickRaid && this.ogl.db.quickRaidList.shift(), 5 === this.ogl.mode && 15 !== fleetDispatcher.mission && this.ogl.db.options.expeditionRedirect && (this.ogl.mode = 0), 1 != this.ogl.mode && 2 != this.ogl.mode && 5 != this.ogl.mode && this.prepareRedirection(), 1 === this.ogl.mode || 2 === this.ogl.mode || 5 === this.ogl.mode && this.ogl.db.options.expeditionRedirect) window.location.href = this.ogl.nextRedirection;
      ...
      this.ogl.cache.reports[e] && (this.ogl.cache.reports[e].attacked = !0), window.location.href = `?page=ingame&component=messages`
    }
...
class MessageManager extends Manager {
  ...
  check() {
    ...
    if (this.reportList = [], [20, 21, 22, 24].indexOf(this.tabID) >= 0) {
      (new DOMParser).parseFromString(ogame.messages.content.join(""), "text/html").querySelectorAll(".msg").forEach((t => {
        ...
        if (a && (this.ogl._time.update(!1, a.querySelector(".msgDate:not(.ogl_updated)")), a.querySelector(".icon_apikey") && o.api && a.querySelector(".icon_apikey").setAttribute("data-api-code", o.api)), 20 == this.tabID && this.ogl.db.options.displaySpyTable && !e) {
          ...
          if (o.date = 1e3 * (parseInt(n.getAttribute("data-raw-timestamp")) + serverTimeZoneOffsetInMinutes), o.coords = n.getAttribute("data-raw-coords"), o.defenderSpace = JSON.parse(n.getAttribute("data-raw-defenderSpaceObject") || "{}"), o.fleets = JSON.parse(n.getAttribute("data-raw-fleets") || "{}"), o.rounds = JSON.parse(n.getAttribute("data-raw-combatrounds") || "{}"), o.result = JSON.parse(n.getAttribute("data-raw-result") || "{}"), o.gain = {
              metal: 0,
              crystal: 0,
              deut: 0
  ...
  createSpyTable() {
    ...
    this.reportList.sort((function (e, o) {
      return void 0 !== e[n] && void 0 !== o[n] || (n = "age"), t && isNaN(e[n]) ? o[n].localeCompare(e[n]) : !t && isNaN(e[n]) ? e[n].localeCompare(o[n]) : t && !isNaN(e[n]) ? o[n] - e[n] : e[n] - o[n]
    })).forEach((t => {
