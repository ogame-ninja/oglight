...
class LangManager extends Manager {
  load() {
    this.raw = {
      ...
      expeditionShipRatio: "Schifffund Wert(%)",
      fleetLimiter: "Flottenbegrenzer",
      fleetLimiterTT: "Wähle die Anzahl an Schiffen / Ressourcen die auf dem Planeten bleiben sollen",
      menu: "Alterniere OGLight menu",
      quickRaid: "Schneller Angriff",
      attackNext: "Attackiere nächsten Planet",
      ...
      collectResources: "Sammle Ressourcen",
      ...
      spyPlanet: "Spioniere diesen Planet",
      spyMoon: "Spioniere diesen Mond",
      resourceLimiter: "Subtrahiere Anzahl der Ressourcen die im Profimaximalwert definiert sind.",
      fleetLimiter: "Subtrahiere Anzahl der Schiffe die im Profimaximalwert definiert sind.",
      forceKeepCapacity: "Genügend Ladekapazität beibehalten um Rohstoffe zu transportieren (hat Priorität über definierten Grenzwerten)",
      ...
      msu: "Metal standard einheit (MSE)",
...
class UIManager extends Manager {
      ...
      if ("svg" != e.target.tagName && "path" != e.target.tagName) {
        ...
        if ((e.target.classList.contains("planetlink") || e.target.classList.contains("moonlink") || e.target.closest(".planetlink, .moonlink")) && document.body.classList.contains("ogl_destinationPicker")) {
          ...
          if (document.body.classList.contains("ogl_initHarvest")) {
            ...
            window.location.href = `?page=ingame&component=fleetdispatch&galaxy=${t[0]}&system=${t[1]}&position=${t[2]}&type=${n}&oglmode=1&ogldestinationid=${i}&oglfirstsourceid=${o}&ogldestinationtype=${3==n?"moon":"planet"}`
          }
          else {
  ...
  turnIntoPlayerLink(e, t, n, o) {
    if (t.setAttribute("title", "loading..."), t.classList.add("tooltipUpdate"), t.classList.add("tooltipRight"), t.classList.add("tooltipClose"), this.ogl.db.udb?.[e]?.status) {
      const n = this.ogl.db.udb[e].status,
        o = "status_abbr_inactive" === n ? this.ogl.db.serverData.inactive : "status_abbr_longinactive" === n ? this.ogl.db.serverData.inactiveLong : "status_abbr_banned" === n ? this.ogl.db.serverData.banned : "status_abbr_vacation" === n && this.ogl.db.serverData.vacation;
      t.setAttribute("data-status-tag", o), t.classList.add(n)
    }
    t.addEventListener("click", (t => {
      ...
      t._tippy.setContent(o), this.ogl._fetch.fetchPlayerAPI(e, n, (() => {
        document.querySelector(".ogl_pinDetail") && this.ogl.db.currentSide == e && this.ogl._topbar.openPinnedDetail(e), t._tippy.setContent(this.getPlayerTooltip(e))
      }))
    }))
  }
  getPlayerTooltip(e) {
    ...
    Util.runAsync((() => this.displayStatus(e))), (!e.statusTimestamp || serverTime.getTime() - e.statusTimestamp > 864e5) && this.ogl._fetch.pending.push({
      ...
      callback: t => {
        ...
        e.statusTimestamp = 1e3 * parseInt(n.querySelector("players").getAttribute("timestamp")), n.querySelectorAll("player").forEach((t => {
          ...
          o.indexOf("v") > -1 && "status_abbr_active" != o ? o = "status_abbr_vacation" : "I" === o ? o = "status_abbr_longinactive" : "i" === o ? o = "status_abbr_inactive" : "b" === o && (o = "status_abbr_banned"), e[n] && typeof e[n] == typeof {} || (e[n] = {}), e[n].status = o, this.ogl.db.udb[n] && (this.ogl.db.udb[n].status = o)
  ...
  displayStatus(e) {
    document.querySelectorAll("#ranks tbody tr").forEach((t => {
      ...
      if (this.ogl.db.udb[n]?.name && o.querySelector(".playername").innerText.indexOf("...") >= 0 && (o.querySelector(".playername").innerText = this.ogl.db.udb[n].name), e[n]) {
        const t = e[n].status,
          a = "status_abbr_inactive" === t ? this.ogl.db.serverData.inactive : "status_abbr_longinactive" === t ? this.ogl.db.serverData.inactiveLong : "status_abbr_vacation" === t ? this.ogl.db.serverData.vacation : "status_abbr_banned" === t && this.ogl.db.serverData.banned;
        o.setAttribute("data-status-tag", a), o.classList.add(t)
      }
      this.turnIntoPlayerLink(n, o), t.querySelector(".ogl_flagPicker") || this.addPinButton(t.querySelector(".position"), n)
    })), initTooltips()
  }
      ...
      document.querySelectorAll(getTooltipSelector()).forEach((e => {
        e._tippy?.oglTooltipReady || (e._tippy ? (e._tippy.setProps({
          ...
          onShow: t => {
            ...
            if (e.classList.contains("planetlink") ? n = this.updatePlanetMenuTooltip(t, "planet") : e.classList.contains("moonlink") ? n = this.updatePlanetMenuTooltip(t, "moon") : "string" == typeof n && n.indexOf('class="fleetinfo"') >= 0 && (n = this.updateFleetTooltip(t)), !1 === n || "" === n) return !1;
...
class MessageManager extends Manager {
  load() {
    this.ogl.cache.reports = this.ogl.cache.reports || {}, this.ogl.cache.raids = this.ogl.cache.raids || {}, this.ogl.cache.counterSpies = this.ogl.cache.counterSpies || [], this.checkBoard(), "messages" === this.ogl.page && (this.tokenReady = !0, this.deleteQueue = [], this.updateStatsTimeout, this.loopQueueTimeout, this.events = {
      mission: 0
  ...
  check() {
    ...
    if (this.reportList = [], [11, 12, 20, 21, 22, 23, 24].indexOf(this.tabID) >= 0) {
      (new DOMParser).parseFromString(ogame.messages.content.join(""), "text/html").querySelectorAll(".msg").forEach((t => {
        ...
        if (!n) return;
        const o = {};
        o.id = t.getAttribute("data-msg-id"), o.globalTypeID = n.getAttribute("data-raw-messagetype"), o.date = 1e3 * parseInt(n.getAttribute("data-raw-timestamp") || n.getAttribute("data-raw-dateTime") || 0), o.api = n.getAttribute("data-raw-hashcode");
        const a = document.querySelector(`[data-msg-id="${o.id}"]`);
        if (a && (this.ogl._time.update(!1, a.querySelector(".msgDate:not(.ogl_updated)")), a.querySelector(".icon_apikey") && o.api && a.querySelector(".icon_apikey").setAttribute("data-api-code", o.api)), 20 != this.tabID && 25 != this.tabID || !this.ogl.db.options.displaySpyTable || e)
          if (21 == this.tabID) {
            if (o.date = 1e3 * parseInt(n.getAttribute("data-raw-timestamp")), o.coords = n.getAttribute("data-raw-coords"), o.defenderSpace = JSON.parse(n.getAttribute("data-raw-defenderSpaceObject") || "{}"), o.fleets = JSON.parse(n.getAttribute("data-raw-fleets") || "{}"), o.rounds = JSON.parse(n.getAttribute("data-raw-combatrounds") || "{}"), o.result = JSON.parse(n.getAttribute("data-raw-result") || "{}"), o.gain = {
                metal: 0,
                crystal: 0,
                deut: 0
              }, o.shipLost = {}, o.resultType = "raid", o.isOwnPlanet = o.defenderSpace.owner?.id == this.ogl.account.id, !o.api || 35 == o.globalTypeID) return;
            const e = o.fleets?.filter((e => e.player?.id == this.ogl.account.id)).map((e => e.fleetId)),
              t = o.fleets?.filter((e => e.player?.id == this.ogl.account.id)).map((e => e.side)),
              i = o.rounds[o.rounds.length - 1];
            o.isAttacker = t.indexOf("attacker") >= 0, o.isDefender = t.indexOf("defende") >= 0, o.isWinner = t.indexOf(o.result.winner) >= 0, o.noWinner = "none" == o.result.winner, o.isWinner && o.isAttacker && (o.gain.metal = o.result.loot.resources.find((e => "metal" == e.resource))?.amount, o.gain.crystal = o.result.loot.resources.find((e => "crystal" == e.resource))?.amount, o.gain.deut = o.result.loot.resources.find((e => "deuterium" == e.resource))?.amount), o.isWinner || o.noWinner || !o.isOwnPlanet || (o.gain.metal = -o.result.loot.resources.find((e => "metal" == e.resource))?.amount, o.gain.crystal = -o.result.loot.resources.find((e => "crystal" == e.resource))?.amount, o.gain.deut = -o.result.loot.resources.find((e => "deuterium" == e.resource))?.amount), i && i.fleets.forEach((t => {
              e.indexOf(t.fleetId) >= 0 && t.technologies.forEach((e => {
                e.destroyedTotal && (o.shipLost[-e.technologyId] = e.destroyedTotal)
              }))
            })), o.isDefender && o.isOwnPlanet && o.result.repairedTechnologies.forEach((e => {
              o.shipLost[-e.technologyId] -= e.amount
            })), o.result?.debris?.resources && (o.debris = {}, o.result.debris.resources.forEach((e => {
              e.remaining > 0 && (o.debris[e.resource?.replace("deuterium", "deut")] = e.remaining)
            }))), o.resultType && (this.summarize(o), this.statify(o)), a && Util.addDom("div", {
              class: "ogl_messageButton tooltip",
              title: "Convert this battle",
              parent: a.querySelector("message-footer-actions"),
              child: "C",
              onclick: () => window.open(Util.genConverterLink(this.ogl, o.api), "_blank")
            })
          }
        else if (22 == this.tabID) {
          if (o.date = 1e3 * parseInt(n.getAttribute("data-raw-timestamp")), o.lifeform = parseInt(n.getAttribute("data-raw-lifeform") || 0), o.expeditionResult = n.getAttribute("data-raw-expeditionresult") || n.getAttribute("data-raw-expeditionResult"), o.resources = JSON.parse(n.getAttribute("data-raw-resourcesGained")?.replace("deuterium", "deut")?.replace("darkMatter", "dm") || "{}"), o.artefact = parseInt(n.getAttribute("data-raw-artifactsFound") || 0), o.lfXP = parseInt(n.getAttribute("data-raw-lifeformGainedExperience") || 0), o.ships = {}, o.delay = JSON.parse(n.getAttribute("data-raw-navigation") || '{ "returnTimeAbsoluteIncreaseHours":0, "returnTimeMultiplier":1 }'), 61 == o.globalTypeID) o.artefact > 0 ? o.resultType = "artefact" : o.lfXP > 0 ? o.resultType = "lifeform" : o.resultType = "nothing";
          else if ("ressources" == o.expeditionResult) o.resultType = "resource";
          else if ("darkmatter" == o.expeditionResult) o.resultType = "darkmatter";
          else if ("nothing" == o.expeditionResult) o.resultType = "nothing";
          else if ("shipwrecks" == o.expeditionResult) o.resultType = "ship";
          else if ("trader" == o.expeditionResult) o.resultType = "trader";
          else if ("items" == o.expeditionResult) o.resultType = "item";
          else if ("fleetLost" == o.expeditionResult) o.resultType = "blackhole";
          else if ("navigation" == o.expeditionResult && o.delay.returnTimeMultiplier < 1) o.resultType = "early";
          else if ("navigation" == o.expeditionResult && (o.delay.returnTimeMultiplier > 1 || o.delay.returnTimeAbsoluteIncreaseHours > 0)) o.resultType = "late";
          else if ("combat" == o.expeditionResult) {
            const e = new RegExp(/\.|,|\(|\)|:/, "g"),
              n = new RegExp(/( de | de$)/, "g"),
              a = t.innerText.replace(e, "").replace(n, " ").toLowerCase(),
              i = this.expeResults.alien.find((e => a.indexOf(e) >= 0)),
              r = this.expeResults.pirate.find((e => a.indexOf(e) >= 0));
            i ? o.resultType = "alien" : r && (o.resultType = "pirate")
          }
          Object.entries(JSON.parse(n.getAttribute("data-raw-technologiesGained") || "{}")).forEach((e => {
            o.ships[e[0]] = e[1].amount
          })), o.gain = {
            ...o.resources,
            ...o.ships,
            artefact: o.artefact,
            ["lifeform" + o.lifeform]: o.lfXP,
            resultType: o.resultType
          }, o.resultType && (this.summarize(o), this.statify(o))
        }
        else 23 != this.tabID && 24 != this.tabID || (o.coords = n.getAttribute("data-raw-coords"), o.debris = JSON.parse(n.getAttribute("data-raw-recycledresources") || "{}"), o.cargo = JSON.parse(n.getAttribute("data-raw-cargo") || "{}"), o.gain = {}, Object.entries(o.debris).forEach((e => {
          e[1] > 0 && (o.gain[e[0].replace("deuterium", "deut")] = e[1], o.resultType = "debris")
        })), o.debris = !1, Object.entries(o.cargo).forEach((e => {
          e[1] > 0 && (o.gain[e[0].replace("deuterium", "deut")] = e[1], o.resultType = "cargo")
        })), o.resultType && (this.summarize(o), 24 == this.tabID && this.statify(o)));
        else {
          this.spytable = document.querySelector(".ogl_spytable"), this.spytable ? this.spytable.classList.remove("ogl_hidden") : (this.spytable = Util.addDom("div", {
            class: "ogl_spytable",
          ...
          })), o.playerID = n.getAttribute("data-raw-targetplayerid"), o.planetID = n.getAttribute("data-raw-targetplanetid"), o.playerName = n.getAttribute("data-raw-playerName"), o.targetType = 1 == n.getAttribute("data-raw-targetPlanetType") ? "planet" : "moon", o.targetTypeID = n.getAttribute("data-raw-targetPlanetType"), o.coords = n.getAttribute("data-raw-coordinates"), o.rawCoords = Util.coordsToID(o.coords), o.age = 1e3 * parseInt(n.getAttribute("data-raw-reportAge")), o.isActive = parseInt(n.getAttribute("data-raw-active")), o.activity = parseInt(n.getAttribute("data-raw-activity")), o.resources = parseInt(n.getAttribute("data-raw-resources")), o.metal = parseInt(n.getAttribute("data-raw-metal")), o.crystal = parseInt(n.getAttribute("data-raw-crystal")), o.deut = parseInt(n.getAttribute("data-raw-deuterium")), o.hiddenFleet = 1 == n.getAttribute("data-raw-hiddenships"), o.hiddenDef = 1 == n.getAttribute("data-raw-hiddendef"), o.fleet = "-" == n.getAttribute("data-raw-fleet") ? {} : JSON.parse(n.getAttribute("data-raw-fleet") || "{}"), o.def = "-" == n.getAttribute("data-raw-defense") ? {} : JSON.parse(n.getAttribute("data-raw-defense") || "{}"), o.loot = parseInt(n.getAttribute("data-raw-loot")), o.fleetValue = 0, o.defValue = 0, o.isAttacked = t.querySelector(".fleetAction.fleetHostile"), !o.isActive && o.activity < 15 && (o.activity = 60);
          let e = o.resources,
            i = 0;
          for (let t = 1; t < 7; t++) e -= i, i = Math.floor(e * o.loot / 100), o["wave" + t] = i;
          if (o.hiddenFleet) o.fleetValue = -1;
          else
            for (let [e, t] of Object.entries(o.fleet)) e > 200 && e < 300 && Object.entries(Datafinder.getTech(Math.abs(e))).forEach((e => o.fleetValue += e[1] * t));
          if (o.hiddenDef) o.defValue = -1;
          else
            for (let [e, t] of Object.entries(o.def)) e > 400 && e < 500 && Object.entries(Datafinder.getTech(Math.abs(e))).forEach((e => o.defValue += e[1] * t));
          if (o.playerName != ogl.account.name && this.reportList.push(o), a) {
            if (!a.querySelector(".ogl_tagPicker")) {
              const e = Util.addDom("div", {
                class: "ogl_messageButton",
                parent: a.querySelector("message-footer-actions")
              });
              this.ogl._ui.addTagButton(e, o.coords)
            }
            a.querySelector(".ogl_trashsim") || Util.addDom("div", {
              class: "ogl_messageButton material-icons ogl_trashsim",
              title: "simulate",
              parent: a.querySelector("message-footer-actions"),
              child: "letter_s",
              onclick: () => window.open(Util.genTrashsimLink(this.ogl, o.api), "_blank")
            }), a.querySelector(".ogl_ptreBtn") || this.ogl.ptreKey && Util.addDom("div", {
              class: "ogl_messageButton material-icons ogl_ptreBtn",
              title: "Send this report to PTRE",
              parent: a.querySelector("message-footer-actions"),
              child: "ptre",
              onclick: () => this.ogl.PTRE.postSpyReport(o.api)
            })
          }
        }
      })), 20 == this.tabID && this.ogl.db.options.displaySpyTable && !e ? this.createSpyTable() : this.spytable && this.spytable.classList.add("ogl_hidden"), 21 != this.tabID && 22 != this.tabID && 24 != this.tabID || this.ogl._stats.miniStats()
    }
    initTooltips()
  }
  summarize(e) {
    ...
    t.querySelector(".ogl_battle") && t.querySelector(".ogl_battle").remove(), t.querySelector(".ogl_checked") || Util.addDom("div", {
      ...
      before: t.querySelector(".msgTitle")
    });
    const n = Util.addDom("div", {
        class: "ogl_battle",
      ...
      o = Object.values(e.gain).reduce(((e, t) => parseInt(e) || 0 + parseInt(t) || 0), 0),
      a = {
        ...e.gain
      };
    if (Object.entries(e.shipLost || {}).forEach((e => {
        !isNaN(e[0]) && e[0] < 0 && Object.entries(Datafinder.getTech(-e[0])).forEach((e => a[e[0]] = (a[e[0]] || 0) - e[1]))
      })), Object.entries(a).forEach((e => {
        isNaN(e[1]) || 0 === e[1] ? 0 == o && isNaN(e[1]) && Util.addDom("div", {
    ...
    a.metal + a.crystal + a.deut == 0 && Util.addDom("div", {
      class: "ogl_icon",
      child: "-",
      parent: n
    }), e.resultType && (n.classList.add("ogl_clickable"), 41 != e.globalTypeID && 61 != e.globalTypeID || t.querySelector(".msgContent").classList.add("ogl_hidden"))
  }
  statify(e) {
  ...
  addToSpyTable(e, t) {
    ...
    for (let t = 1; t < 7; t++) {
      ...
      this.ogl.fretShips.forEach((t => {
        ...
        Util.addDom("a", {
          ...
          href: `?page=ingame&component=fleetdispatch&galaxy=${p[0]}&system=${p[1]}&position=${p[2]}&type=${e.targetTypeID}&mission=1&am${t}=${i}&oglmode=4&oglLazy=true`
        })
      }))
    }
    ...
    const b = Util.addDom("a", {
        ...
        href: `?page=ingame&component=fleetdispatch&galaxy=${p[0]}&system=${p[1]}&position=${p[2]}&type=${e.targetTypeID}&mission=1&am${this.ogl.db.options.defaultShip}=${r}&oglmode=4`
      }),
      f = Util.addDom("span", {
    ...
    this.addSpyIcons(h, e.coords, e.targetType), this.ogl._ui.addTagButton(m, e.coords), e.activity < 15 ? u.classList.add("ogl_danger") : e.activity < 60 && u.classList.add("ogl_warning"), e.wave1 >= this.ogl.db.options.resourceTreshold && b.classList.add("ogl_important"), 0 != e.fleetValue && (f.style.background = "linear-gradient(192deg, #622a2a, #3c1717 70%)"), 0 != e.defValue && (y.style.background = "linear-gradient(192deg, #622a2a, #3c1717 70%)"), this.nextTarget || 0 != e.fleetValue || 0 != e.defValue || e.isAttacked || (this.nextTarget = e), Util.addDom("div", {
    ...
    const v = Util.addDom("a", {
      ...
      parent: x,
      child: "target",
      href: `?page=ingame&component=fleetdispatch&galaxy=${p[0]}&system=${p[1]}&position=${p[2]}&type=${e.targetTypeID}&mission=1`
    });
  ...
  createSpyTable() {
    ...
    let t = this.ogl.db.spytableSort?.indexOf("DESC") >= 0,
      n = this.ogl.db.spytableSort?.replace("DESC", "");
    this.reportList.sort((function (e, o) {
      return null != !e[n] && null != !o[n] || (n = "age"), !e[n] && 0 != e[n] || !o[n] && 0 != o[n] ? e - o : t && isNaN(e[n]) ? o[n].localeCompare(e[n]) : !t && isNaN(e[n]) ? e[n].localeCompare(o[n]) : t && !isNaN(e[n]) ? o[n] - e[n] : e[n] - o[n]
    })).forEach((t => {
...
class ShortcutManager extends Manager {
  ...
  redirectToPlanet(e) {
    ...
    let n = {};
    n.component = t.get("component"), n.ogldestinationtype = t.get("ogldestinationtype"), n.ogldestinationid = t.get("ogldestinationid"), n.oglfirstsourceid = t.get("oglfirstsourceid"), n.galaxy = t.get("galaxy"), n.system = t.get("system"), n.position = t.get("position"), n.type = t.get("type");
    ...
    const d = {};
    d.component = n.component, d.cp = 1 == e ? "moon" == a ? r.moonID : i.id : "moon" == a ? s.moonID : l.id, this.ogl.mode && (d.oglmode = this.ogl.mode), n.ogldestinationtype && (d.ogldestinationtype = n.ogldestinationtype);
    for (let [e, t] of Object.entries(n)) t && (d[e] = t);
    !this.ogl.mode || n.oglfirstsourceid != i.id && n.oglfirstsourceid != r.moonID ? window.location.href = this.getRedirectionLink(d) : window.location.href = this.getRedirectionLink({
      component: "overview",
      cp: d.cp
    })
  }
  getRedirectionLink(e) {
    e = e || {};
    let t = `?page=ingame`;
    for (let [n, o] of Object.entries(e)) t += `&${n}=${o}`;
    return t
  }
}
class TechManager extends Manager {
  ...
  getTechData(e, t, n) {
    ...
    let c = d.target.duration / 1e3,
      ...
      h = Math.floor(c % 3600 / 60),
      m = Math.floor(c % 60),
      b = 0;
    return d.target.timeresult = "", p > 0 && b < 3 && (d.target.timeresult += `${p}${LocalizationStrings.timeunits.short.week} `, b++), g > 0 && b < 3 && (d.target.timeresult += `${g}${LocalizationStrings.timeunits.short.day} `, b++), u > 0 && b < 3 && (d.target.timeresult += `${u}${LocalizationStrings.timeunits.short.hour} `, b++), h > 0 && b < 3 && (d.target.timeresult += `${h}${LocalizationStrings.timeunits.short.minute} `, b++), m > 0 && b < 3 && (d.target.timeresult += `${m}${LocalizationStrings.timeunits.short.second}`, b++), d
  }
