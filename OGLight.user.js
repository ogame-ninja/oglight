...
class OGLight {
  ...
  getPlanetData() {
    ...
    (!this.db.lastLFBonusUpdate || Date.now() > this.db.lastLFBonusUpdate + 3e5 && "fleetdispatch" != this.page) && setTimeout((() => this._fetch.fetchLFBonuses()), t ? 7500 : 0), (!this.db.lastEmpireUpdate || Date.now() > this.db.lastEmpireUpdate + 3e5 && "fleetdispatch" != this.page) && setTimeout((() => this._fetch.fetchEmpire()), t ? 1e4 : 0), (!this.db.lastProductionQueueUpdate || Date.now() > this.db.lastProductionQueueUpdate + 3e4 && "fleetdispatch" != this.page) && setTimeout((() => this._fetch.fetchProductionQueue()), t ? 3e3 : 0), this.db.myPlanets[e] = this.db.myPlanets[e] || {}, this.currentPlanet.obj = this.db.myPlanets[e], this.currentPlanet.obj.type = document.querySelector('head meta[name="ogame-planet-type"]').getAttribute("content"), this.currentPlanet.obj.metal = Math.floor(resourcesBar.resources.metal?.amount || 0), this.currentPlanet.obj.crystal = Math.floor(resourcesBar.resources.crystal?.amount || 0), this.currentPlanet.obj.deut = Math.floor(resourcesBar.resources.deuterium?.amount || 0), this.currentPlanet.obj.energy = Math.floor(resourcesBar.resources.energy?.amount || 0), this.currentPlanet.obj.food = Math.floor(resourcesBar.resources.food?.amount || 0), this.currentPlanet.obj.population = Math.floor(resourcesBar.resources.population?.amount || 0), this.currentPlanet.obj.lifeform = document.querySelector("#lifeform .lifeform-item-icon")?.className.replace(/\D/g, ""), this.currentPlanet.obj.lastRefresh = this._time.serverTime, ["metal", "crystal", "deut"].forEach((e => {
  ...
  updateJQuerySettings() {
    ...
    $(document).on("ajaxSend", (function (t, n, o) {
      ...
      if (o.url.indexOf("page=messages") >= 0) {
...
class UIManager extends Manager {
  ...
  turnIntoPlayerLink(e, t, n) {
    t.classList.add("tooltipUpdate"), t.classList.add("tooltipRight"), t.classList.add("tooltipClose"), t.addEventListener("click", (t => {
      e == this.ogl.account.id || t.ctrlKey || (t.preventDefault(), this.ogl._topbar.openPinnedDetail(e))
    })), t.addEventListener("tooltip", (() => {
      this.ogl._tooltip.update(Util.addDom("div", {
        child: '<div class="ogl_loading"></div>'
      })), this.ogl._fetch.fetchPlayerAPI(e, n, (() => {
        document.querySelector(".ogl_pinDetail") && this.ogl.db.currentSide == e && this.ogl._topbar.openPinnedDetail(e), (document.querySelector(`.ogl_tooltip #player${e}`) || this.ogl._tooltip.lastSender == t) && this.ogl._tooltip.update(this.getPlayerTooltip(e), t)
      }))
    }))
  }
  getPlayerTooltip(e) {
  ...
  addPinButton(e, t) {
    const n = this.ogl.db.udb[t],
      o = Util.addDom("div", {
        ...
        parent: e,
        ontooltip: e => {
          this.ogl._tooltip.tooltip.appendChild(a)
        },
        onclick: e => {
  ...
  addTagButton(e, t, n) {
    const o = Util.coordsToID(t),
      ...
      i = Util.addDom("div", {
        ...
        parent: e,
        ontooltip: e => {
          n || this.ogl._tooltip.tooltip.appendChild(r)
        },
        onclick: e => {
  ...
  addSpyIcons(e, t, n, o) {
    if (t = "string" == typeof t ? t = t.split(":") : t, "planet" == n || !n) {
      const n = Util.addDom("div", {
          ...
          "data-title": this.ogl._lang.find("spyPlanet"),
      ...
      if (serverTime.getTime() - a < this.ogl.db.options.spyIndicatorDelay && (n.setAttribute("data-spy", "recent"), n.setAttribute("data-title", "recently spied")), o) {
    ...
    if ("moon" == n || !n && this.ogl.db.pdb[`${t[0]}:${t[1]}:${t[2]}`]?.mid) {
      const n = this.ogl.db.pdb[`${t[0]}:${t[1]}:${t[2]}`]?.mid > 0 ? Util.addDom("div", {
          class: "material-icons ogl_spyIcon tooltip",
          "data-title": this.ogl._lang.find("spyMoon"),
      ...
      if (serverTime.getTime() - a < this.ogl.db.options.spyIndicatorDelay && (n.setAttribute("data-spy", "recent"), n.setAttribute("data-title", "recently spied")), o && this.ogl.db.pdb[`${t[0]}:${t[1]}:${t[2]}`]?.mid > -1) {
        const e = this.ogl.db.pdb[`${t[0]}:${t[1]}:${t[2]}`]?.acti || [],
          o = serverTime.getTime() - e[2] < 36e5,
          a = Util.addDom("span", {
            parent: n,
  ...
  updateLeftMenu() {
    ...
    if (Util.addDom("a", {
      ...
      Util.addDom("span", {
        ...
        child: '<a class="tooltipRight" data-title="PTRE last request status" href="#"><i class="material-icons">sync_alt</i></a>',
...
class TopbarManager extends Manager {
  load(e) {
    this.topbar = Util.addDom("div", {
      ...
      class: "material-icons tooltipTop",
  ...
  openAccount() {
    ...
    document.querySelectorAll(".smallplanet").forEach((t => {
      ...
      a.upgrades?.baseBuilding?.[0]?.name.trim() == ogl.db.serverData[2] && serverTime.getTime() < a.upgrades.baseBuilding[0].end && (d.querySelector("strong").innerHTML += `<span>${a[2]+1}</span>`);
      let c = Util.addDom("div", {
        class: "ogl_deut",
        parent: e,
        child: `<strong>${a[3]}</strong><small>+${Util.formatToUnits(Math.round(3600*(a.proddeut||0)*24))}</small>`
      });
      n.metal += a[1], n.crystal += a[2], n.deut += a[3], n.prodmetal += a.prodmetal || 0, n.prodcrystal += a.prodcrystal || 0, n.proddeut += a.proddeut || 0, a.upgrades?.baseBuilding?.[0]?.name.trim() == ogl.db.serverData[3] && serverTime.getTime() < a.upgrades.baseBuilding[0].end && (c.querySelector("strong").innerHTML += `<span>${a[3]+1}</span>`)
    ...
    const n = () => {
      ...
      n.planets.sort(((e, t) => Util.coordsToID(e) - Util.coordsToID(t))).forEach((e => {
        ...
        p === r ? i.setAttribute("data-group", g) : i.previousElementSibling?.getAttribute("data-group") && g++, p = r, Util.addDom("div", {
          ...
          class: "tooltip",
          "data-title": "Debris<br>" + Util.formatNumber(t.debris || 0),
        ...
        const d = Util.addDom("date", {
          class: "tooltipLeft",
          child: s,
          "data-title": `<span>${n.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric"})}</span> <span>${n.toLocaleTimeString("de-DE")}</span>`,
          parent: i
        });
          ...
          if (o.innerText = "", n.length < 1) Util.addDom("p", {
            ...
            n.forEach(((n, a) => {
              ...
              const c = Util.addDom("div", {
                ...
                "data-title": "Select as next quick raid target",
                child: "swords",
                parent: l,
                onclick: () => {
...
class FleetManager extends Manager {
  ...
  overwrite() {
    this.overwrited = !0, fleetDispatcher.fleetHelper.getShipData = e => shipsData[e], fleetDispatcher.refreshDataAfterAjax = e => {
      ...
      if (a) {
        const e = Util.addDom("div", {
          child: a.getAttribute("title") || a.getAttribute("data-title")
        });
        if (e) {
  ...
  init() {
    ...
    this.updateSpeedBar(), this.ogl.shipsList.forEach((e => {
      if (fleetDispatcher.fleetHelper.shipsData?.[e]) {
        ...
        n.setAttribute("data-title", `\n                    <div class="ogl_shipDataInfo">\n                        <div class="ogl_icon ogl_${e}">${t.name}</div><hr>\n                        <i class="material-icons">send</i> Amount : <b>${Util.formatNumber(parseInt(n.querySelector(".amount").getAttribute("data-value")))}</b><br>\n                        <i class="material-icons">package-variant-closed</i> Capacity : <b>${Util.formatNumber(t.cargoCapacity||t.baseCargoCapacity)}</b><br>\n                        <i class="material-icons">mode_heat</i> Consumption : <b>${Util.formatNumber(t.fuelConsumption)}</b><br>\n                        <i class="material-icons">speed</i> Speed : <b>${Util.formatNumber(t.speed)}</b>\n                    </div>\n                `)
      }
    })), fleetDispatcher.selectMission(parseInt(fleetDispatcher.mission) || parseInt(this.ogl.db.options.defaultMission)), fleetDispatcher.speedPercent = fleetDispatcher.speedPercent || 10, fleetDispatcher.realSpeedPercent = fleetDispatcher.speedPercent, 1 === this.ogl.mode || 2 === this.ogl.mode ? (fleetDispatcher.selectShip(this.ogl.db.options.defaultShip, this.shipsForResources()), fleetDispatcher.selectMaxAll()) : 5 === this.ogl.mode && this.ogl.db.options.expeditionRedirect && this.selectExpedition(this.ogl.db.lastExpeditionShip || this.ogl.db.options.defaultShip), fleetDispatcher.refresh(), fleetDispatcher.focusSubmitFleet1(), document.querySelector(".secondcol") && (Util.runAsync((() => {
      ...
      ontooltip: () => {
        const e = Util.addDom("div", {
          ...
          t = ["metal", "crystal", "deut", "food"];
        t.forEach((t => {
          const n = Util.addDom("div", {
              class: `ogl_icon ogl_${t}`,
              parent: e,
              onclick: () => {
                o.value = o.value == fleetDispatcher[this.resOnPlanet[t]] ? 0 : fleetDispatcher[this.resOnPlanet[t]], fleetDispatcher[this.cargo[t]] = o.value, o.dispatchEvent(new Event("input"))
              }
            }),
            o = Util.addDom("input", {
              type: "text",
              ...
              oninput: () => {
                Util.formatInput(o, (() => {
                  o.value = Math.min(fleetDispatcher[this.resOnPlanet[t]], parseInt(o.value.replace(/\D/g, "")) || 0), fleetDispatcher[this.cargo[t]] = o.value, o.value = parseInt(o.value.replace(/\D/g, "") || 0).toLocaleString("fr-FR")
                }))
              }
            })
        })), Util.addDom("hr", {
          ...
          onclick: () => {
            ...
            e.querySelectorAll("input").forEach((e => {
              n += parseInt(e.value.replace(/\D/g, "")) || 0
            })), n > 0 && fleetDispatcher.selectShip(this.ogl.db.options.defaultShip, this.shipsForResources(!1, n)), e.querySelectorAll("input").forEach(((e, n) => fleetDispatcher[this.cargo[t[n]]] = parseInt(e.value.replace(/\D/g, "") || 0))), this.ogl._tooltip.close(), fleetDispatcher.refresh(), setTimeout((() => fleetDispatcher.focusSubmitFleet1()), 50)
          }
        }), this.ogl._tooltip.update(e), e.querySelector("input").focus()
      }
...
class TooltipManager extends Manager {
  load() {
    this.openTimeout, this.lastSender, this.lastActiveSender, this.shouldWait = !1, this.tooltip = Util.addDom("div", {
      class: "ogl_tooltip",
      parent: document.body
    }), document.querySelector("#metal_box")?.getAttribute("title") || getAjaxResourcebox(), this.init()
  }
  init(e) {
    e = e || this;
...
class MessageManager extends Manager {
  load() {
    ...
    this.expeResults = e ? JSON.parse(e) : Datafinder.getAllExpeditionsText(), Util.overWrite("doInitAction", unsafeWindow.ogame.messages, !1, (() => {
  ...
  checkRaids(e, t) {
    ...
    document.querySelector(`.ui-tabs-panel[aria-labelledby="${n}"]`).querySelectorAll(".msg").forEach((e => {
      ...
      const n = e.getAttribute("data-msg-id"),
        ...
        a = (o.getAttribute("title") || o.getAttribute("data-title") || o.getAttribute("data-api-code")).match(/cr-[a-z0-9-]*/)[0];
      o.setAttribute("data-api-code", a), Util.addDom("div", {
        ...
        callback: o => {
          ...
          this.ogl.cache.raids[n] = i, this.buildRecap(i, e), i.probesOnly || t || this.updateStats(i)
        }
      }), Util.addDom("div", {
        class: "ogl_messageButton tooltip",
        "data-title": "Convert this battle",
  ...
  checkRR() {
    document.querySelectorAll('#ui-id-2 div[aria-hidden="false"] .msg').forEach((e => {
      ...
      if (n) {
        const e = (n.getAttribute("title") || n.getAttribute("data-title") || n.getAttribute("data-api-code")).match(/rr-[a-z0-9-]*/)[0];
  ...
  checkDialog() {
    ...
    if (t && n && !e.querySelector(".ogl_messageButton")) {
      const t = e.querySelector(".icon_apikey"),
        n = (t.getAttribute("title") || t.getAttribute("data-title") || t.getAttribute("data-api-code")).match(/cr-[a-z0-9-]*/)[0];
      ...
      const t = new URLSearchParams(e.querySelector(".msg_title a")?.href),
        ...
        o = e.querySelector(".icon_apikey"),
        a = (o.getAttribute("title") || o.getAttribute("data-title") || o.getAttribute("data-api-code")).match(/sr-[a-z0-9-]*/)[0];
  ...
  buildRecap(e, t) {
    ...
    const o = {};
    if (e.percentage && (n.setAttribute("data-title", `${e.percentage}% max.`), n.classList.add("tooltip")), "raid" == e.messageType) {
  ...
  addBoardTab() {
    const e = Util.addDom("div", {
        id: "oglBoardTab",
        parent: document.querySelector(".js_tabs")
      }),
      t = Util.addDom("div", {
        class: "tab_ctn",
        parent: e
      ...
      o = Util.addDom("li", {
        class: "list_item ui-tabs-tab ui-corner-top ui-state-default ui-tab ogl_boardMessageTab",
        parent: document.querySelector("ul.tabs_btn"),
        onclick: () => {
          o.querySelector(".new_msg_count") && o.querySelector(".new_msg_count").remove(), "" == e.innerText && (n.innerHTML = '<div class="ogl_wrapperloading"><div class="ogl_loading"></div></div>', GM_xmlhttpRequest({
            method: "GET",
            url: "https://board.fr.ogame.gameforge.com/index.php?board-feed/101/",
            onload: e => {
              const t = (new DOMParser).parseFromString(e.responseText, "text/xml").querySelectorAll("item");
              n.innerHTML = "", t.forEach(((e, t) => {
                const o = new Date(e.querySelector("pubDate").textContent),
                  a = o.toLocaleDateString("de-DE", {
                    day: "2-digit",
                    month: "2-digit",
                    year: "numeric"
                  }),
                  i = o.toLocaleTimeString("de-DE"),
                  r = Util.addDom("div", {
                    class: "msg",
                    parent: n
                  });
                ...
                }), 0 == t && (this.ogl.db.lastBoardPosts[1] = o.getTime())
              })), this.ogl._time.updateList.push(".ogl_CustomMessagedate"), this.ogl.db.lastBoardPosts[0] = 0, this.ogl.db.lastBoardPosts[2] = Date.now()
            }
          }))
        }
      });
    o.innerHTML = '\n            <a href="#oglBoardTab" class="tabs_btn_img" role="presentation" tabindex="-1">\n                <div class="material-icons">menu_book</div>\n                <span class="icon_caption">Board.fr</span>\n                <div class="marker"></div>\n            </a>\n        ', this.ogl.db.lastBoardPosts[0] > 0 && Util.addDom("span", {
      class: "new_msg_count",
      child: this.ogl.db.lastBoardPosts[0],
      parent: o.querySelector("a")
...
class MovementManager extends Manager {
  ...
  updateMovement() {
    document.querySelectorAll("#movementcomponent .reversal a").length > 0 && (document.querySelectorAll("#movementcomponent .reversal a")[0].setAttribute("data-key-color", "orange"), Array.from(document.querySelectorAll("#movementcomponent .reversal a")).sort(((e, t) => parseInt(t.closest(".fleetDetails").getAttribute("id").replace("fleet", "")) - parseInt(e.closest(".fleetDetails").getAttribute("id").replace("fleet", ""))))[0].setAttribute("data-key-color", "violet")), document.querySelectorAll(".route a").forEach(((e, t) => {
      e.classList.add("tooltipRight");
      const n = e.closest(".fleetDetails"),
        o = Util.addDom("div", {
      ...
      document.querySelector(`#${e.getAttribute("rel")}`).querySelectorAll(".fleetinfo tr").forEach((e => {
        if (e.querySelector("td") && e.querySelector(".value")) {
          const t = e.querySelector("td").innerText.replace(":", ""),
            n = Object.entries(this.ogl.db.serverData).find((e => e[1] === t))[0],
            a = parseInt(e.querySelector(".value").innerText.replace(/\.|,| /g, "")),
            i = Util.formatToUnits(a, 0);
          if (!a) return;
          isNaN(n) ? "metal" == n ? Util.addDom("div", {
            ...
            class: `ogl_icon ogl_${n}`,
            child: i,
            after: o.querySelector(".ogl_metal")
          }) : "deut" == n ? Util.addDom("div", {
            class: `ogl_icon ogl_${n}`,
            child: i,
            after: o.querySelector(".ogl_crystal")
          }) : "food" == n && Util.addDom("div", {
            class: `ogl_icon ogl_${n}`,
            child: i,
            after: o.querySelector(".ogl_deut")
          }) : Util.addDom("div", {
            class: `ogl_icon ogl_${n}`,
            child: i,
            parent: o
      ...
      })), 18 == n.getAttribute("data-mission-type") && (Util.addDom("div", {
        class: "ogl_icon ogl_metal",
        child: 0,
        prepend: o
      }), Util.addDom("div", {
      ...
      r.appendChild(n.querySelector(".timer")), r.appendChild(n.querySelector(".absTime")), r.appendChild(n.querySelector(".originData")), r.querySelector(".originData").appendChild(r.querySelector(".originCoords")), l.appendChild(n.querySelector(".destinationData")), l.querySelector(".destinationData").appendChild(l.querySelector(".destinationPlanet")), n.querySelector(".nextabsTime") ? l.appendChild(n.querySelector(".nextabsTime")) : Util.addDom("div", {
        child: "-",
        parent: l
      }), n.querySelector(".nextTimer") ? l.appendChild(n.querySelector(".nextTimer")) : Util.addDom("div", {
        child: "-",
        parent: l
      }), Util.addDom("div", {
        class: `ogl_icon ogl_mission${n.getAttribute("data-mission-type")}`,
        prepend: i
      }), i.appendChild(n.querySelector(".route a")), n.querySelector(".fedAttack") && i.appendChild(n.querySelector(".fedAttack")), n.querySelector(".sendMail") && i.appendChild(n.querySelector(".sendMail")), n.prepend(o), n.prepend(a), n.prepend(i)
...
class ShortcutManager extends Manager {
  load() {
    document.querySelector(".ogl_shortcuts")?.remove(), document.querySelector(".ogl_shortCutWrapper")?.remove(), this.keyList = {}, this.shortCutWrapper = Util.addDom("div", {
      ...
      let t = document.activeElement.tagName;
      "INPUT" != t && "TEXTAREA" != t && (!this.keyList[e.key.toLowerCase()] || this.locked || e.ctrlKey || e.shiftKey ? isNaN(e.key) || !this.keyList["2-9"] || this.locked || e.ctrlKey || e.shiftKey || (this.locked = !0, this.keyList["2-9"](e.key)) : (this.locked = !0, this.keyList[e.key.toLowerCase()]()), !e.repeat && "enter" == e.key.toLowerCase() && this.ogl._tooltip.tooltip.classList.contains("ogl_active") && this.ogl._tooltip.tooltip.querySelector(".ogl_formValidation") && this.ogl._tooltip.tooltip.querySelector(".ogl_formValidation").click())
...
class TechManager extends Manager {
  ...
  check(e, t) {
    ...
    if (document.querySelector(`#technologies .technology[data-technology="${e}"] .targetlevel`)?.getAttribute("data-value") >= this.initialLevel && (this.initialLevel += 1), a) {
      ...
      const i = Util.addDom("div", {
        ...
        r = Util.addDom("div", {
          parent: i,
          "data-title": this.ogl._lang.find("repeatQueue"),
  ...
  displayLevel(e, t, n, o) {
    ...
    if (r.innerText = "", o.querySelector(".build_duration time").innerText = a.target.timeresult, o.querySelector(".additional_energy_consumption .value")) {
      ...
      n.classList.add("tooltip"), 217 == e && (a.target.conso = parseInt(n.getAttribute("data-value")) * (t || 1)), n.setAttribute("data-title", Util.formatNumber(a.target.conso)), n.innerHTML = Util.formatToUnits(a.target.conso, !1, !0)
    }
    ...
    Util.addDom("div", {
      ...
      if (o.querySelector(`.costs .${e.replace("deut","deuterium")}`)) {
        ...
        n.setAttribute("data-title", Util.formatNumber(a.target[e])), Util.addDom("div", {
          class: "tooltip",
          "data-title": Util.formatNumber(a.target[e]),
          parent: n,
          child: Util.formatToUnits(a.target[e], 2)
        }), o.querySelector(".build_amount") || Util.addDom("div", {
          parent: n,
          class: "ogl_text tooltip",
          "data-title": Util.formatNumber(i[e]),
          child: Util.formatToUnits(i[e], 2)
        }), t < 0 ? Util.addDom("div", {
          parent: n,
          class: "ogl_danger tooltip",
          "data-title": Util.formatNumber(t),
    ...
    Util.addDom("div", {
      class: "tooltip",
      "data-title": Util.formatNumber(c),
      parent: d,
    ...
    o.querySelector(".build_amount") || Util.addDom("div", {
      parent: d,
      class: "ogl_text tooltip",
      "data-title": Util.formatNumber(p),
...
class StatsManager extends Manager {
  ...
  miniStats() {
    ...
    Object.entries(o.total).forEach((e => {
      Util.addDom("div", {
        ...
        parent: l,
        child: `<span>${Util.formatToUnits(e[1])}</span>`
      })
    })), document.querySelector(".ogl_blackHoleButton") || this.addBlackHoleButton()
  }
  buildStats(e, t) {
    const n = serverTime;
  ...
  displayDetails(e, t, n, o) {
    ...
    ["", "send", "metal", "crystal", "deut", "msu", "dm", "artefact"].forEach((e => {
      ...
      if (o[e]) {
        ...
        a.classList.add("tooltip"), a.setAttribute("data-title", t)
      }
  ...
  addBlackHoleButton() {
    Util.addDom("button", {
      ...
      "data-title": this.ogl._lang.find("reportBlackhole"),
      parent: this.miniDiv,
      child: "cyclone",
      onclick: () => {
...
class Util {
  ...
  static observe(e, t, n, o) {
    ...
    t = t || {}, new MutationObserver((e => {
      o && "progress" !== e[0].target.tagName.toLowerCase() && (Util.runAsync(o._time.update, o._time), Util.runAsync(o._time.observe, o._time), document.querySelector('[class*="tooltip"]:not(.ogl_ready)') && (clearTimeout(a), a = setTimeout((() => {
        Util.runAsync(o._tooltip.init, o._tooltip)
      }), 200)), document.querySelector('[onclick*="sendShips(6"]:not([data-spy-coords]), [onclick*="sendShipsWithPopup(6"]:not([data-spy-coords])') && (clearTimeout(i), i = setTimeout((() => {
  ...
  static getMSU(e, t, n, o) {
    return (e || 0) + (t || 0) * (o = o.split(":"))[0] / o[1] + (n || 0) * o[0]
  }
